...
const LoginRegister = () => {
    ...
    window.onload = function () {
        ...
        axios.get('http://mps-portal.vercel.app:5000/user/remember', {
            params: {
            ...
            .then(
                function (response) {
                    ...
                    if (response.data.data._id === auth.token) {
                        window.location.replace(`http://mps-portal.vercel.app:3000/CharacterSelection/:${response.data.data.userID}`)
                    }
                })
    ...
    const termsconditions = () => {
        window.open('http://mps-portal.vercel.app:3000/terms&conditions')
    };

    const forgotpassword = () => {
        window.open('http://mps-portal.vercel.app:3000/forgot')
    };

    //signup
    const handleRegister = (event) => {
        event.preventDefault();
        axios.post('http://mps-portal.vercel.app:5000/user/signup', {
    ...
    const handleLogin = (event) => {
        event.preventDefault();
        axios.get('http://mps-portal.vercel.app:5000/user/signin', {
            params: {
